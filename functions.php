...
// List child pages
if ( ! function_exists( 'endurance_list_child_pages' ) ) {
	function endurance_list_child_pages() {
		...
		if ( $childpages ) {
				$string = '<ul class="page_children_list">' . $childpages . '</ul>';
		}
	...
	add_shortcode('list_child_pages', 'endurance_list_child_pages');
}
